...
import { 
  Personal, 
  RolComercial, 
  ClasificacionComercial as TipoClasificacionComercial, 
  EspecialidadAgro, 
  ROLES_COMERCIALES,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-medium">{CLASIFICACIONES_COMERCIALES[formData.clasificacion_comercial as TipoClasificacionComercial]}</p>
              </div>
            </div>
