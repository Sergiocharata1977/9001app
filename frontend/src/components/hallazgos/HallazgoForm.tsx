...
const HallazgoForm: FC<HallazgoFormProps> = ({ onSubmit, onCancel, initialData }) => {
  ...
  const handleSelectChange = (name: keyof HallazgoFormData, value: string): void => {
    setFormData(prev => ({ ...prev, [name]: value }));
  };
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Select 
            onValueChange={(value) => handleSelectChange('tipo_hallazgo', value)} 
